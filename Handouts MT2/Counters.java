...
public class Counters
{
	...
	// method (mostly for clarity to the reader of the program).   The int
	// variables below must be instance variables because they are accessed
	// in the constructor and in an ActionListener.  However, the CountListener
	// variable below is a method variable because it is only needed locally
	// (once the listener is set up, we don't need the variable anymore).
	...
	public Counters()
	{
		...
		// text.  We are only using 2 of those sections here.
	...
	// Simple listener to quit the program
