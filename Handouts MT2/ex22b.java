// CS 401 Fall 2017
// Compare to ex22a.  Instead of a JLabel we are now using a JButton.
...
public class ex22b
{
	public static void main(String [] args)
	{
		...
		// Note the position of the JButton within the JFrame.  Soon we will
		// see how to arrange multiple components within a window.
...
class MyListener implements ActionListener
{
	...
	// cast it to our desired JButton class.
	public void actionPerformed(ActionEvent e)
	{
		JButton theEventer = (JButton) e.getSource();
		theEventer.setForeground(theColors[index]);
		//theButton.setForeground(theColors[index]);  // will not work since theButton
												// is out of scope
